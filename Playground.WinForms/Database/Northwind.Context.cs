...
namespace Playground.WinForms.Database
{
    ...
    public partial class NorthwindEntities : DbContext
    {
        ...
        [DbFunction("NorthwindEntities", "StringSplit")]
        public virtual IQueryable<string> StringSplit(string input, string separator)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<string>("[NorthwindEntities].[StringSplit](@input, @separator)", inputParameter, separatorParameter);
        }
    }
}
